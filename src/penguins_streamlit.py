...
st.write("""
         This app uses 6 inputs to predict the species of penguin using a model built on the Palmer Penguins dataset. Use the form below to get started!
         """)
penguin_df = pd.read_csv("../data/penguins.csv")
rf_pickle = open("../models/random_forest_penguin.pickle", 'rb')
map_pickle = open("../models/output_penguin.pickle", 'rb')
